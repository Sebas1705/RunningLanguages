...
Rational* Rational::sum(const Rational* a){
    Rational r = Rational(
...
Rational* Rational::minus(const Rational* a){
    Rational r = Rational(
        this->num*a->den-this->den*a->num,
        this->den*a->den
    );
...
Rational* Rational::mult(const Rational* a){
    Rational r = Rational(
        this->num*a->num,
        this->den*a->den
    );
...
bool Rational::equalsTo(const void* other) {
