...
int TablaHashDeEstudiantes::buscarEstudiante (int clave) {
	...
	int posicion = obtenerPosicion(clave); // Posicion en donde buscamos inicialmente. Empezamos por donde idealmente debería estar
	...
	// o hasta encontrar una casilla vacia y no borrada. O, negando todo lo anterior (usando el álgebra de bool), 
