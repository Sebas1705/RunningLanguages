...
public:
	...
	// Postcondición: el árbol sigue siendo un montículo despues de insertar el nuevo elemento
	// Complejidad temporal: O(logn)
	void insertar(int nuevoElemento);

	// Borra la raiz
	// Precondición: el monticulo no esta vacio
	// Complejidad temporal: O(logn)
	void borrar();
...
private:
	...
	// Comprueba si el árbol que empieza en el nodo dado como argumento es un monticulo
	...
	// Convierte en un montículo algo que ya es un monticulo excepto la raiz
	// Precondiciones:
	// - el subarbol izquierdo y el subarbol derecho son montículos
