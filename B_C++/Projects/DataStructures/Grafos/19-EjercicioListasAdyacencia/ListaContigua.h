...
public:
	...
	// Complejidad temporal: O(1)
	Aeropuerto getValor(int posicion);
	...
	// - posicion en [0, n-1]
	// Complejidad temporal: O(1)
	void setValor(int posicion, Aeropuerto nuevoValor);
	...
	void insertarAlFinal (Aeropuerto nuevoValor);
	...
	// - posicion en [0, n]
	// Complejidad temporal: O(n)
	void insertar(int posicion, Aeropuerto nuevoValor);
