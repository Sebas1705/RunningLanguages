...
public final class ActivitySecondBinding implements ViewBinding {
  ...
  private ActivitySecondBinding(@NonNull LinearLayout rootView,
      @NonNull FrameLayout containerQuestions) {
    this.rootView = rootView;
    this.containerQuestions = containerQuestions;
  }
  ...
  public static ActivitySecondBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.containerQuestions;
      FrameLayout containerQuestions = ViewBindings.findChildViewById(rootView, id);
      if (containerQuestions == null) {
        break missingId;
      }

      return new ActivitySecondBinding((LinearLayout) rootView, containerQuestions);
    }
